...
Here we present some experimental details, primarily showcasing the specific performance of AutoAstro on common classification and time-series analysis tasks in astronomy, as shown in the tables below.
